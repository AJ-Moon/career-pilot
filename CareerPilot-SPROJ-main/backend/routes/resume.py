...
def summarize_resume(parsed_data):
    summary = {
        ...
        "education_summary": [line.split("|")[0] for line in parsed_data["education"][:3]],
        "projects_summary": [line.split("|")[0] for line in parsed_data["projects"][:3]],
        "work_experience_summary": [line.split("|")[0] for line in parsed_data["work_experience"][:3]],
