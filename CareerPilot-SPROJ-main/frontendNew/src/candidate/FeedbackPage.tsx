...
const strengths = [
  {
    ...
    description:
      "Demonstrated strong understanding of algorithms and data structures",
    score: 92,
    icon: CheckCircle,
  ...
  },
  {
    ...
    description:
      "Effectively broke down complex problems into manageable parts",
    score: 85,
    icon: CheckCircle,
    color: "text-green-500",
  },
...
const improvements = [
  ...
  },
  {
    ...
    tips: [
      ...
      "Think about performance limits",
    ],
  },
];
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-muted-foreground">
              {domain} • Completed {new Date().toLocaleDateString()}
            </p>
          </div>
        </div>
